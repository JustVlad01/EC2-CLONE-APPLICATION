  ...
  <div class="side-bar">
    ...
    <ul>
      ...
      <SubList>
        ...
        <template #sub-items>
          <li><router-link to="/admin/category/all">View Categories</router-link></li>
          <li><router-link to="/admin/category/add">Add Category</router-link></li>
        </template>
      </SubList>
      <!-- END CATEGORY ITEM -->
